...
- wheel 触发 emit zoom deltaY，App 里 scale 乘以 1.1：拖拽触发 emit pan dx、dy，累加 offsetX 与 offsetY
...
- 切换结论时 O1 清空高亮数组，不必重建几何：同一条边可在不同结论里重复高亮，基础灰线网不变
...
- 用 ⇒ 切结论列表：播放、滚轮或点击改 currentIndex：emit activeConclusion index, text
...
- 大题时点太多时，只画 segment 声明的边与高亮边，不要全连线
