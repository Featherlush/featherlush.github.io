...
1. 先熟悉论文面板布局与 D3 绑定，理解一屏多图共享年份
2. 再进入统计平台，重点是年、季、产业、地区四个维度与多块 ECharts 同步刷新
3. Java 端我不写代码，但图表联调必须知道报表 Controller 暴露了哪些 GET 接口

## 与纯 ECharts 模板项目的差异

课题组另一套图表模板仓库是 **单页多 chart 文件、ECharts 为主**。本课题里：

- 论文线大量 **D3 与静态 JSON**，更像定制信息图：统计线是 **ECharts 地图、饼图、瀑布与折线**，且强依赖后端聚合

两套栈在同一段时间并行，能更清楚地区分 **静态制图** 与 **接口驱动的仪表盘** 两种交付形态。

## 延伸阅读

按技术合集阅读，日期由早到晚大致如下。：[Vue.js 手记](/blog/series/vue-notes)，论文面板 Vuex 布局，11 月下旬：[D3.js 手记](/blog/series/d3-notes)，Python 预处理与 JSON 管线，12 月上旬：[ECharts 手记](/blog/series/echarts-notes)，统计仪表盘图表页，12 月中旬：[Spring Boot 手记](/blog/series/spring-boot-notes)，后端结构梳理，联调视角，12 月下旬
