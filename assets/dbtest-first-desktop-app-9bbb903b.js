...
- 忘记先连接就点插入，要靠 IsDbConnected 兜底：改完数据要记得再查询一遍才能刷新 Grid：状态既要 label1，又要 MessageBox，重复但直观
...
- 课程示例与批改环境以 Visual Studio 与窗体设计器为主：MySql.Data 文档与 NuGet 一键引用，比纯 C++ 接 MySQL Connector 省时间：课设截止在 12 月，能稳定演示 CRUD 优先
