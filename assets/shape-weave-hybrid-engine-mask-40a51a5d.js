...
- 请求未带 engine 时读 SHAPEWEAVE_DEFAULT_ENGINE 或有 Key 用智谱：智谱未配置 ZHIPU_API_KEY 时，只能 local：models/ 底模目录不存在时，只能 zhipu
...
- generate_templates.py / sync_shapes_to_templates.py：器形图与 mask 对齐：generate_pattern_examples.py：示例 input/output 说明 conditioning 质量
