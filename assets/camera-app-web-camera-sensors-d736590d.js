...
- 用 ideal 而不是固定像素，让浏览器在性能与清晰度之间自选；真机上 videoWidth/videoHeight 常与 CSS 显示尺寸不一致，拍照合成时要再算裁剪见下文：翻转镜头只改 facingMode 并先 stop 旧轨道再重新 getUserMedia，避免双路占用摄像头导致黑屏：audio false 减少权限弹窗干扰；课程项目不需要录像
...
- maxNumFaces 1 限制单人场景：关闭 AR 时 stopAR：faceMesh.close、清空 Canvas、isARActive = false：未使用 @mediapipe/camera_utils 的 Camera 类依赖已安装但未引用，手写 rAF 更直观，但少了官方对帧率的上限控制
