...
- el-table 绑定 users
- 添加用户打开 el-dialog，dialogType === 'add' 时展示密码框
- 编辑时回填行数据，password 留空表示不改
- el-switch 绑定 is_admin
...
- 搜索标题/内容、按发布者 el-select 筛选
- 表格展示缩略图、视频图标，点击预览
- POST /posts 新增、PUT /posts/:id 编辑、DELETE 删除
- 媒体字段 image 与 video 同样先 upload 再写 URL
