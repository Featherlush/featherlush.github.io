...
- 浏览器直接打开 dist/index.html 本地文件，控制台 404 /assets/...：APK 安装后首页空白，Network 里主 bundle 加载失败
...
- 先 build 再打包，改 Vue 代码后必须重新 npm run build
- 旧 WebView 可保留 legacy 插件，同时测一台旧 Android
- build.minify 调试时可关，发布前按需打开压缩
- 图片走 src/assets 或 public，引用时用相对路径
