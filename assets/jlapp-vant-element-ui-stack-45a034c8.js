...
- 设计稿分类区更像多栏目门户，Element Tab 切换动画与样式成熟
- 同一屏要挂 4 个子列表页，用 Vue Router children 比 Vant Tab 内嵌路由更清晰
...
- 登录页大量 inline style \`margin-top: 16%\` 等，竞赛赶进度时的真实写法，后期可收进 scoped 或 CSS 变量
- Vant 主题色通过 \`plain type="primary"\` 与 CSS 变量 \`#1989fa\` 统一
